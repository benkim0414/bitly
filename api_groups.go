...
func (r ApiGetGroupMetricsByCitiesRequest) Unit(unit string) ApiGetGroupMetricsByCitiesRequest {
	r.unit = &unit
	return r
}
...
/*
 * GetGroupMetricsByCities Get Click Metrics for a Group by City
...
func (r ApiGetGroupMetricsByCountriesRequest) Unit(unit string) ApiGetGroupMetricsByCountriesRequest {
	r.unit = &unit
	return r
}
...
/*
 * GetGroupMetricsByCountries Get Click Metrics for a Group by Country
...
func (r ApiGetGroupMetricsByDevicesRequest) Unit(unit string) ApiGetGroupMetricsByDevicesRequest {
	r.unit = &unit
	return r
}
...
/*
 * GetGroupMetricsByDevices Get Click Metrics for a Group by Device Type
...
/*
 * GetGroupMetricsByReferringNetworks Get Click Metrics for a Group by Referring Networks
...
func (r ApiGetGroupShortenCountsRequest) Unit(unit string) ApiGetGroupShortenCountsRequest {
	r.unit = &unit
	return r
}
