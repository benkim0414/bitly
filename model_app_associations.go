...
type AppAssociations struct {
	AndroidInstallPreference *string `json:"android_install_preference,omitempty"`
	IosInstallPreference *string `json:"ios_install_preference,omitempty"`
...
// SetAndroidInstallPreference gets a reference to the given string and assigns it to the AndroidInstallPreference field.
...
// SetIosInstallPreference gets a reference to the given string and assigns it to the IosInstallPreference field.
